...
4. **transfer_to_researcher** - 委派上游研究子代理（自主学习能力）
...
**知识库应该存放结构化的短条目（100字以内），作为研究子代理的主动学习源。**
...
4. **主动学习**：想学新菜时通过研究子代理主动问"教我做红烧肉"，而不是被动接收"你可能需要知道500道菜"
