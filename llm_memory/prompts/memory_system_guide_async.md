...
- 示例：用户修复BUG → "用户具备修复BUG的开发能力"

**第二步：技能总结**
- 提问："能否从中提炼出通过交互'新学到'或'被验证有效'的可复用策略？"
- **元技能示例**：用户巧妙安抚他人 → "先共情再讨论问题的沟通策略"
- **领域技能示例**：用户分享游戏角色玩法 → "角色'雷电将军'的标准操作流程"
...
- **`useful_notes`**: 与当前对话强相关的笔记ID列表
  ...
  - 必须确保与对话话题直接相关，而不是仅仅因为包含用户或助理的名字
  - 如果不确定相关性，请留空
...
### 错误5：信息重复
- ❌ 错误：已有"用户具备修复BUG能力"的知识记忆，又生成"我见证了用户修复BUG"的任务记忆
