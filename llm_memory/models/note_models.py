...
class NoteData:
    ...
    @classmethod
    def create_file_block(cls, block_id: str, content: str, file_id: int,
                         tag_ids: List[int], related_ids: List[str] = None) -> 'NoteData':
        """
        创建文件块笔记
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'NoteData':
        ...
        try:
            tag_ids = json.loads(tag_ids_str) if isinstance(tag_ids_str, str) else tag_ids_str
